...
func selectErrMessage(errMsg string) (SelectQueryObject, error) {
...
func ComputeSelectQueryByParam(modelRef interface{}, tableName string, queryParam QueryParamType) (SelectQueryObject, error) {
